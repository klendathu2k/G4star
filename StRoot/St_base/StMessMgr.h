...
// Generic Messages:
   virtual ostrstream_& Message(const char* mess="", const char* type="",
...
public:
// Info Messages:
   virtual ostrstream_& Info(const char* mess="", const char* opt="O",const char *sourceFileName=0, int lineNumber=-1)=0;
...
// Warning Messages:
   virtual ostrstream_& Warning(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1)= 0;
...
// Error Messages:
   virtual ostrstream_& Error(const char* mess="", const char* opt="E",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// Debug Messages:
   virtual ostrstream_& Debug(const char* mess="", const char* opt="OT",const char *sourceFileName=0, int lineNumber=-1)= 0;
...
// QAInfo Messages:
   virtual ostrstream_& QAInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// UCMInfo Messages:
   virtual ostrstream_& UCMInfo(const char* mess="", const char* opt="OS",const char *sourceFileName=0, int lineNumber=-1) = 0;
...
// "As is" Messages:
   virtual ostrstream_& out(const char* mess="") = 0;
   virtual ostrstream_& err(const char* mess="") = 0;

   virtual       void PrintInfo() =0;
   // Fatal Messages:
   virtual ostrstream_& Fatal(const char* mess="", const char* opt="OT",const char *sourceFileName=0, int lineNumber=-1)= 0;
