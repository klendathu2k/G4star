...
// Info Messages:
   virtual ostrstream_& Info(const char* mess="", const char* opt="O"
...
// Warning Messages:
   virtual ostrstream_& Warning(const char* mess="", const char* opt="E"
                             ,const char *sourceFileName=0, int lineNumber=-1);
...
// Error Messages:
   virtual ostrstream_& Error(const char* mess="", const char* opt="E"
                           ,const char *sourceFileName=0, int lineNumber=-1);
...
// Debug Messages:
   virtual ostrstream_& Debug(const char* mess="", const char* opt="OT"
                           ,const char *sourceFileName=0, int lineNumber=-1);
...
// QAInfo Messages:
   virtual ostrstream_& QAInfo(const char* mess="", const char* opt="OS"
                            ,const char *sourceFileName=0, int lineNumber=-1);
...
// UCMInfo Messages:
   virtual ostrstream_& UCMInfo(const char* mess="", const char* opt="OS"
                            ,const char *sourceFileName=0, int lineNumber=-1);
...
// "As is" Messages:
   virtual ostrstream_& out(const char* mess="");
   virtual ostrstream_& err(const char* mess="");

   virtual       void PrintInfo();

   // Fatal Messages:
   virtual ostrstream_& Fatal(const char* mess="", const char* opt="F",const char *sourceFileName=0, int lineNumber=-1);
