...
//______________________________________________________________________________
ostrstream_ &StLoggerManager::Stream()
{
...
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Message(const char* mess, const char* type,
...
// Info Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Info(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
...
// Warning Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Warning(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
...
// Error Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Error(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
...
// Debug Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Debug(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
...
// QAInfo Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::QAInfo(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
{ return Message(mess, "Q", opt,sourceFileName,lineNumber);}
//_____________________________________________________________________________
//
// UCMInfo Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::UCMInfo(const char* mess, const char* opt,const char *sourceFileName,int lineNumber)
...
//_____________________________________________________________________________
ostrstream_& StLoggerManager::Fatal(const char* mess, const char* opt,const char *sourceFileName, int lineNumber)
{ return Message(mess,"F",opt,sourceFileName,lineNumber);}

// "As is" Messages:
//_____________________________________________________________________________
ostrstream_& StLoggerManager::out(const char* mess)
{return Message(mess,"I","OP-");}
//_____________________________________________________________________________
ostrstream_& StLoggerManager::err(const char* mess)
...
// ostrstream_& gMess = *(StMessMgr *)StLoggerManager::Instance();
