  ...
  TObjectSet(_name)
{
  ...
  TParticlePDG *He3   = new TParticlePDG( "He3",   "Helium-3", /* mass */ 3.0160293      *u,  true,  0., 2.0, "heavyion", hid(2,3,0),   0, 49 );
  TParticlePDG *Alpha = new TParticlePDG( "alpha", "Helium-3", /* mass */ 4.001506179127 *u,  true,  0., 2.0, "heavyion", hid(2,4,0),   0, 47 );
  ...
  AddParticle("D",   D);
  AddParticle("He3", He3);
  AddParticle("alpha",Alpha);  AddAlias("He4","alpha");
  AddParticle("Cu",  Cu);
  AddParticle("Au",  Au);
  AddParticle("U",   U);
