...
double _phid = 0;
//___________________________________________________________________
void throw_muon_in_fts_wedge( int wedgeid, int inout, int charge = 1 ) {
...
void unit_test_fst_hits() {
  ...
  LOG_TEST << "=======================================================" << std::endl;
  LOG_TEST << "Unit testing of tracks and FST hits on single muons"     << std::endl;
  LOG_TEST << "=======================================================" << std::endl;

  throw_muon_in_fts_wedge( 0, 0 );
  ...
  check_track( "A muon must have been processed by geant",       [=](const g2t_track_st* t){
    ...
    check_track( "There should not be a stop vertex in the FST",   [=](const g2t_track_st* t){
